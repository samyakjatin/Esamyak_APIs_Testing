...
public class GemStoneController01 {
    ...
    public void updateUser() {
        ...
        String jsonBody = "{\n" +
        	    ...
        	    "  \"code\": \"string\",\n" +
        	    "  \"srNo\": 0,\n" +
        	    "  \"GemStoneId\": \"3fa85f64-5717-4562-b3fc-2c963f66afa6\",\n" +
        	    "  \"name\": \"string\",\n" +
        	    "  \"count\": 0,\n" +
 ...
 //  String userId = "7828500F-5781-40D5-9E61-ADF2A09EB993";
      String gemStoneId = "cd33a27a-b131-11ef-a57f-c8d3ffbc6ac6"; 
      
      
          // request.pathParam("userId", userId);
         // request.pathParam("auctionId", auctionId);
          request.pathParam("gemStoneId", gemStoneId);
        
        // Send the PUT request
        Response response = request.put("/gem-stone/{gemStoneId}");
