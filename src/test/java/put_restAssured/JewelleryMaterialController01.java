...
public class JewelleryMaterialController01 {
 ...
 //  String userId = "7828500F-5781-40D5-9E61-ADF2A09EB993";
      String jewelleryMaterialId = "cd3e0999-b131-11ef-a57f-c8d3ffbc6ac6"; 
      
      
          // request.pathParam("userId", userId);
         // request.pathParam("auctionId", auctionId);
          request.pathParam("jewelleryMaterialId", jewelleryMaterialId);
        
        // Send the PUT request
        Response response = request.put("/jewellery-material/{jewelleryMaterialId}");
