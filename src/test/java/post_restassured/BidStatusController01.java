...
public class BidStatusController01 {
    ...
    public void createSymmetry() {
        ...
        Response response = request.post("/bid-status");  // Updated the endpoint to match the class name context
