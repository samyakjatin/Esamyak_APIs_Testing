...
public class CutController03 {
    ...
    public void createSymmetry() {
        ...
        File file = new File("C:\\Users\\ESAMYAK121\\Desktop\\Testing\\cut_Masters_Excel.xlsx");  // Update with actual file path
        
        // Add the file as part of the multipart request
        request.multiPart("file", file);
        
        // Send the POST request
        Response response = request.post("/cut/excel");
